<template>
  <div
    ...
    :class="typeof thisDayMidday != 'undefined' && thisDayMidday[0].main.temp > 16 ? 'warm' : 'cool'"
  >
    <div class="row">
      <div class="container">
        <searchBar />
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="row">
                    ...
                    <ForecastThreeHourly v-for="forecast of thisDayForecasts" :key="forecast.id" :forecast="forecast" />
                  </div>
                </div>
              </div>
            </div>
...
.cool {
  /* background: radial-gradient( circle farthest-corner at 10% 20%,  rgba(234,199,199,1) 0%, rgb(7, 29, 197) 99.3% ); */

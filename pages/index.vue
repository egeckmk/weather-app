<template>
  <div
    ...
    :class="typeof weather.main != 'undefined' && weather.main.temp > 16 ? 'warm' : typeof weather.main != 'undefined' && weather.main.temp <= 16 ? 'cool' : 'initial'"
  >
    <div class="row">
      <div class="container">
        <searchBar :visibilty="typeof weather.main != 'undefined'" />
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="row">
                    ...
                    <ForecastThreeHourly v-for="forecast of threeHourlyToday" :key="forecast.id" :forecast="forecast" />
                  </div>
                </div>
              </div>
            </div>
...
.initial {
  background: url('/background-init.jpg') center center/cover no-repeat;
}

.warm {
  background: linear-gradient(180deg, rgba(202, 50, 50, 1) -15%, rgba(252, 195, 12, 1) 100%);
}

.cool {
  background: linear-gradient(180deg, #031125 -15%, #8db8f5 100%)
}

.main-icon {
  width: 85%;
  filter: invert(99%) sepia(1%) saturate(7500%) hue-rotate(173deg) brightness(115%) contrast(101%);

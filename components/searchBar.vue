<template>
  ...
  <div class="row d-flex justify-content-center">
    <div class="d-flex flex-column justify-content-center align-items-center text-center p-3 search-box" :class="typeof weather.main != 'undefined' ? 'top-screen col-md-10 col-sm-9 col-9' : 'mid-screen w-75'">
      <svg
      v-if="!visibilty"
        id="Layer_1"
        class="logo"
    ...
    <div
      v-if="visibilty"
      class="col-md-2 col-sm-3 col-3 d-flex flex-column justify-content-center text-center p-3"
    >
      <b-button
        class="back-button"
        href="/"
